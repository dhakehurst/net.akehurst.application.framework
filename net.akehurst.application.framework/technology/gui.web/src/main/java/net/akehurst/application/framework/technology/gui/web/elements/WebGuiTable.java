...
public class WebGuiTable extends WebGuiElement implements IGuiTable {

    public WebGuiTable(final IGuiRequest guiRequest, final IGuiScene scene, final IGuiDialog dialog, final String elementName) {
