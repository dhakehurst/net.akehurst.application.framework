...
public class WebGuiGraph extends WebGuiElement implements IGuiGraphViewer {

    public WebGuiGraph(final IGuiRequest guiRequest, final IGuiScene scene, final IGuiDialog dialog, final String elementName) {
