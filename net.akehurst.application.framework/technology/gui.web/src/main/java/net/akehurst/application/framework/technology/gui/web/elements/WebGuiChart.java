...
public class WebGuiChart<X, Y> extends WebGuiElement implements IGuiChart<X, Y> {

    private final IGuiChartData<X, Y> data;

    public WebGuiChart(final IGuiRequest guiRequest, final IGuiScene scene, final IGuiDialog dialog, final String elementName) {
        super(guiRequest, scene, dialog, elementName);
        this.data = new WebGuiChartData<>();
    }
