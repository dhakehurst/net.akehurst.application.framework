...
public class WebGuiScene implements IGuiScene {
    public WebGuiScene(final String afId, final IGuiRequest guiRequest, final StageIdentity stageId, final SceneIdentity sceneId) {
        this.afId = afId;
    ...
    public IGuiElement getElement(final String elementName) {
        return new WebGuiElement(this.guiRequest, this, null, elementName);
    }
