...
public class WebGuiDiagram extends WebGuiElement implements IGuiDiagram {

    public WebGuiDiagram(final IGuiRequest guiRequest, final IGuiScene scene, final IGuiDialog dialog, final String elementName) {
