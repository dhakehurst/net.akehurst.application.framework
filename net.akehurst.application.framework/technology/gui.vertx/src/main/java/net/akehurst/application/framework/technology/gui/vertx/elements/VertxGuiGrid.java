...
public class VertxGuiGrid extends VertxGuiElement implements IGuiGrid {

	public VertxGuiGrid(final IGuiRequest guiRequest, final IGuiScene scene, final IGuiDialog dialog, final String elementName) {
