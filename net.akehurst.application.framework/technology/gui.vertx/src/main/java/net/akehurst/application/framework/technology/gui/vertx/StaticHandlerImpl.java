...
public class StaticHandlerImpl implements StaticHandler {
	  ...
	  protected boolean rangeSupport = DEFAULT_RANGE_SUPPORT;
	   ...
	   */
	  protected void writeCacheHeaders(HttpServerRequest request, FileProps props) {
	  ...
	  protected <T> T wrapInTCCLSwitch(Callable<T> callable, Handler<AsyncResult<FileProps>> resultHandler) {
	    try {
	      if (classLoader == null) {
	  ...
	  protected void sendFile(RoutingContext context, String file, FileProps fileProps) {
	    HttpServerRequest request = context.request();
	  ...
	  protected String getFile(String path, RoutingContext context) {
