...
public class JdoTransaction implements IPersistenceTransaction {
	...
	public Query<? extends Persistable> newQuery(final Class<? extends Persistable> enhancedType, final String queryString) {
		return this.manager.newQuery(enhancedType, queryString);
	}
